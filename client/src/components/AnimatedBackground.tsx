...
const AnimatedBackground = () => {
  ...
  useEffect(() => {
    ...
    const createVectorElement = () => {
      ...
      element.style.animation = `vector-float ${
        4 + Math.random() * 6
      ...
      if (theme === "dark") {
        element.style.background =
          "linear-gradient(45deg, rgba(184, 207, 206, 0.1), rgba(127, 140, 170, 0.08))";
        element.style.boxShadow = "0 0 20px rgba(184, 207, 206, 0.1)";
      } else {
        element.style.background =
          "linear-gradient(45deg, rgba(184, 207, 206, 0.15), rgba(51, 52, 70, 0.1))";
